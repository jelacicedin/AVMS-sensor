...
namespace MIConvexHull
{
    ...
    class MathHelper
    {
        ...
        void Normalize(double[] x)
        {
            ...
            double f =Convert.ToSingle( 1.0f/ Math.Sqrt(norm));
        ...
        void FindNormalVector4dD(VertexWrap[] pointCloud, double[] normal)
        {
            ...
            double norm =Convert.ToSingle( System.Math.Sqrt(nx * nx + ny * ny + nz * nz + nw * nw));
        ...
        /// <param name="pointCloud"></param>
        /// <param name="normal"></param>
        void FindNormalVector3dD(VertexWrap[] pointCloud, double[] normal)
        {
            SubtractFast(pointCloud[1].PositionData, pointCloud[0].PositionData, ntX);
            SubtractFast(pointCloud[2].PositionData, pointCloud[1].PositionData, ntY);
            ...
            double norm = Convert.ToSingle( System.Math.Sqrt(nx * nx + ny * ny + nz * nz));
        ...
        /// <param name="pointCloud"></param>
        /// <param name="normal"></param>
        void FindNormalVector2D(VertexWrap[] pointCloud, double[] normal)
        {
            SubtractFast(pointCloud[1].PositionData, pointCloud[0].PositionData, ntX);
            ...
            double norm = Convert.ToSingle(System.Math.Sqrt(nx * nx + ny * ny));
        ...
        public void FindNormalVector(VertexWrap[] pointCloud, double[] normalData)
        {
            switch (Dimension)
            {
                case 2: FindNormalVector2D(pointCloud, normalData); break;
                case 3: FindNormalVector3dD(pointCloud, normalData); break;
                case 4: FindNormalVector4dD(pointCloud, normalData); break;
                default:
                    {
