...
namespace MIConvexHull
{
        ...
        where TFace : ConvexFace<TVertex, TFace>
    {
        /// <summary>
        /// Adjacency: An array 
        /// If F = Adjacency[i] then the pointCloud shared with F are Vertices[j] where j != i.
        /// In the context of triangulation, can be null (indicates the cell is at boundary).
        /// </summary>
        public TFace[] Adjacency { get; set; }

        /// <summary>
        /// The pointCloud stored in clockwise order (for dimensions 2 - 4, higher dimensions the order is arbitrary).
