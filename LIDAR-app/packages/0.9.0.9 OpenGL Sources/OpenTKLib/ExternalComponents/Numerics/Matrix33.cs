...
namespace NLinear
{
    ...
    public struct Matrix3d3<T> : IEquatable<Matrix3d3<T>>
        where T : IEquatable<T>
    {
        ...
        public Matrix3d3(T a, T b, T c, T d, T e, T f, T g, T h, T i)
        {
            x = new Numeric<T>[3][];
        ...
        /// <param name="v2"></param>
        /// <returns></returns>
        public static Matrix3d3<T> operator +(Matrix3d3<T> v, Matrix3d3<T> v2)
        {
            return new Matrix3d3<T>(v2[0][0] + v.x[0][0],
                                     v2[0][1] + v.x[0][1],
                                     v2[0][2] + v.x[0][2],
                                     v2[1][0] + v.x[1][0],
                                     v2[1][1] + v.x[1][1],
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static Matrix3d3<T> operator -(Matrix3d3<T> v)
        {
            return new Matrix3d3<T>(-v.x[0][0],
                                     -v.x[0][1],
                                     -v.x[0][2],
                                     -v.x[1][0],
                                     -v.x[1][1],
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static Matrix3d3<T> operator *(Matrix3d3<T> v2, T c)
        {
            return new Matrix3d3<T>(v2[0][0] * c,
                                 v2[0][1] * c,
                                 v2[0][2] * c,
                                 v2[1][0] * c,
                                 v2[1][1] * c,
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static Matrix3d3<T> operator *(T c, Matrix3d3<T> v2)
        {
            return new Matrix3d3<T>(v2[0][0] * c,
                                 v2[0][1] * c,
                                 v2[0][2] * c,
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Vector2<T> operator *(Vector2<T> v, Matrix3d3<T> m)
        {
        ...
        /// <param name="v"></param>
        /// <param name="m"></param>
        public static Vector3d<T> operator *(Vector3d<T> v, Matrix3d3<T> m)
        {
        ...
        /// <returns></returns>
        public Matrix3d3<T> SetRotation(T angle, T unit)
        {
        ...
        /// Set matrix to scale by s
        /// </summary>
        public Matrix3d3<T> SetScale(Vector2<T> s, T unit)
        {
            x[0][0] = s[0];
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        /// Set matrix to scale by s
        /// </summary>
        public Matrix3d3<T> Scale(Vector2<T> s)
        {
            x[0][0] *= s[0];
            x[0][1] *= s[0];
            x[0][2] *= s[0];
        ...
        /// </summary>
        public Matrix3d3<T> SetTranslation(Vector2<T> t, T unit)
        {
            x[0][0] = unit;
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        /// translate by t
        /// </summary>
        public Matrix3d3<T> Translate(Vector2<T> t)
        {
        ...
        public Matrix3d3<T> SetShear(T xy, T unit)
        {
            x[0][0] = unit;
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        public Matrix3d3<T> SetShear(Vector2<T> h, T unit)
        {
            x[0][0] = unit;
            x[0][1] = h[1];
            x[0][2] = Numeric<T>.Zero();
        ...
        public static bool operator ==(Matrix3d3<T> v1, Matrix3d3<T> v2)
        {
