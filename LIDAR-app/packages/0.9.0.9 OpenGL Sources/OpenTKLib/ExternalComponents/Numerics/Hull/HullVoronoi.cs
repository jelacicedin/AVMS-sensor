...
namespace NLinear
{
    public class Hull
    {
        ...
        public Vector3d<double> Center;
        public List<VertexHull> Vertices;
        public List<Edge> Edges;

        public Hull(Box myBox, Vector3d<double> myCenter)
        {
            this.Center = new Vector3d<double>(myCenter);
        ...
        private void SetHullVoronoiFromEdges(Plane3<double> myPlane)
        {
            ...
            while (ii < Edges.Count)
            {
                ...
                else if (Edges[ii].p1.Condition == 0 && Edges[ii].p2.Condition == 2)
                {
                    ...
                    Vector3d<double> vIntersect = myPlane.Intersect(line);
