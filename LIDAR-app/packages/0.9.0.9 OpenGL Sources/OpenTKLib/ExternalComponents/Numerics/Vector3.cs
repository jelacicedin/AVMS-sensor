...
namespace NLinear
{
    ...
    /// </summary>
    /// <typeparam name="T">A numeric type (double, int, ...)</typeparam>
        ...
        where T : IEquatable<T>
    {
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static T operator ^(Vector3d<T> c1, Vector3d<T> c2)
        {
            return c1.Dot(c2);
        }
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public Vector3d<T> Cross(Vector3d<T> v)
        {
            return new Vector3d<T>(y * v.z - z * v.y,
                              z * v.x - x * v.z,
                              x * v.y - y * v.x);
        }
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static Vector3d<T> operator %(Vector3d<T> c1, Vector3d<T> c2)
        {
            return c1.Cross(c2);
        }
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static Vector3d<T> operator -(Vector3d<T> c1)
        {
            Vector3d<T> v = new Vector3d<T>();
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        public static Vector3d<T> operator *(Vector3d<T> c1, T c)
        {
            Vector3d<T> v = new Vector3d<T>();
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        public static Vector3d<T> operator *(T c, Vector3d<T> c1)
        {
            Vector3d<T> v = new Vector3d<T>();
        ...
        /// </summary>
        /// <returns></returns>
        public Vector3d<T> Normalize(T unit)
        {
            T l = Length(unit);
        ...
        /// </summary>
        /// <returns></returns>
        public Vector3d<T> Normalized(T unit)
        {
            T l = Length(unit);
            ...
            if (numL.Equals(Numeric<T>.Zero()))
                return new Vector3d<T>(Numeric<T>.Zero());

            return new Vector3d<T>(x / l, y / l, z / l);
        }
        ...
        private static bool Equals(ref Vector3d<T> v1, ref Vector3d<T> v2)
        {
            return EqualityComparer<T>.Default.Equals(v1.X, v2.X)
                && EqualityComparer<T>.Default.Equals(v1.Y, v2.Y)
                && EqualityComparer<T>.Default.Equals(v1.Z, v2.Z);
        ...
        public T DistanceTo(Vector3d<T> other, T unit)
        {
            T dx = this.x - other.x;
            T dy = this.y - other.y;
            T dz = this.z - other.z;
