    ...
    public class InPolyh
    {
        ...
        */
        ...
        public int ComputeBox(int F, tPointi bmin, tPointi bmax)
        {
            ...
            radius = Convert.ToSingle(Math.Sqrt(Math.Pow((double)(bmax.p[Xindex] - bmin.p[Xindex]), 2) +
                            Math.Pow((double)(bmax.p[Yindex] - bmin.p[Yindex]), 2) +
                            Math.Pow((double)(bmax.p[Zindex] - bmin.p[Zindex]), 2)  ));
            System.Diagnostics.Debug.WriteLine("radius =  " + radius);
        ...
        public int PlaneCoeff(tPointi T, tPointd N, double D0)
        {
            ...
            double biggest = 0.0f;  /* Largest component of normal vector. */
