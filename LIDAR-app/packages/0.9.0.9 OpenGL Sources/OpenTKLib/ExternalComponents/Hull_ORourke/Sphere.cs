...
a given z and a given angle.
	The default output is integers, Rounded from the doubleing point 
...
public void print_instruct()
{
  ...
  System.Diagnostics.Debug.WriteLine ( "\t-f            \t set output to doubleing point format (default: integer) ");
...

{
  ...
  double x, y, z, w, t;
  double R = 100.0f;	/* default radius */
  int r1a, r2a, r3a;
...
public void TestFlags (String[] args)
{
  ...
  while ( i < args.Length) {
    ...
    /* Test whether user wants doubleing point output */
    if (args[i].Equals("-f"))
      double_pt = true;
