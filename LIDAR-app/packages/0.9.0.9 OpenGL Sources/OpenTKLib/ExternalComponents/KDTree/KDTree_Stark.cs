...
namespace OpenTKLib
{
    public class KDTree_Stark
    {
        ...
        static int FindSplitPoint(PointCloudVertices points, int[] inds, int stIndex, int enIndex, int axis)
        {
        ...
        //	of its plane.
        public static int FindPivotIndex(PointCloudVertices points, int[] inds, int stIndex, int enIndex, int axis)
        {
