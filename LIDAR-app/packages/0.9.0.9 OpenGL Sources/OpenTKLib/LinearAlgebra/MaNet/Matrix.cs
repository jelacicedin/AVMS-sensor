...
using System.IO;
using System.Data;
namespace OpenTKLib.old
{
   
    /// <summary>
   ///The Java Matrix Class provides the fundamental operations of numerical
   ///linear algebra.  Various constructors create Matrices from two dimensional
   ///arrays of double precision doubleing point numbers.  Various "gets" and
 ...
 * ------------------------ */
   ...
   */
   ...
   public MatrixOld(int m, int n, double s)
   {
      this.m = m;
      this.n = n;
      A = new double[m,n];
   ...
   /////<param name="m">Number of rows.</param>
   /////<param name="n">Number of colums.</param>
   //public Matrix3d (double[,] A, int m, int n) {
   //   this.A = A;
   //   this.m = m;
   //   this.n = n;
   //}
   ...
   /////<param name="m">Number of rows.</param>
   //public Matrix3d (double[] vals, int m) 
   //{
   //   this.m = m;
...
///<returns> A(i,j)</returns>
   ...
   */
   ...
   //public void SetMatrix (int i0, int i1, int j0, int j1, Matrix3d X) {
   //   try {
   //      for (int i = i0; i <= i1; i++) {
   //         for (int j = j0; j <= j1; j++) {
   //            A[i,j] = X[i-i0,j-j0];
   ...
   //public void SetMatrix (int[] r, int[] c, Matrix3d X) {
   //   try {
   ...
   //public void SetMatrix (int[] r, int j0, int j1, Matrix3d X) {
   //   try {
   //      for (int i = 0; i < r.Length; i++) {
   //         for (int j = j0; j <= j1; j++) {
   //            A[r[i],j] = X[i,j-j0];
   ...
   //public void SetMatrix (int i0, int i1, int[] c, Matrix3d X) 
   //{
   //   try {
   //      for (int i = i0; i <= i1; i++) {
   //         for (int j = 0; j < c.Length; j++) {
...
///<returns> A + B</returns>
   ...
   public MatrixOld TimesEquals (double s)
   {
      for (int i = 0; i < m; i++) {
         for (int j = 0; j < n; j++) {
            A[i,j] = s*A[i,j];
