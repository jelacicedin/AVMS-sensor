    ...
    public class EigenvalueDecomposition
    {
        ...
        */
        ...
        private void tred2()
        {
            ...
            for (int i = n - 1; i > 0; i--)
            {
                ...
                else
                {
                    ...
                    double f = d[i - 1];
                    double g = Convert.ToSingle(Math.Sqrt(h));
                    if (f > 0)
                    {
                        g = -g;
                    }
        ...
        private void tql2()
        {
            ...
            double f = 0.0f;
            double tst1 = 0.0f;
            double eps =  Convert.ToSingle(Math.Pow(2.0, -52));
            for (int l = 0; l < n; l++)
            {
        ...
        public Matrix3d V
        {
            get
            {
                ...
                mat = mat.FromDoubleArray(Varray);
                return mat;
            }
